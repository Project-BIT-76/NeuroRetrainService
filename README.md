Файлы нейронной сети требуется добавить в папку /work_data. В контейнере tensorflow она также смонтирована как /work_dir в основной директории контейнера
